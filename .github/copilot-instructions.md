...
- This repository is a **Deno + Fresh v2** web app with **Preact islands** and
  Tailwind CSS.
...
- Do not introduce new frameworks or large structural refactors unless
...
- Keep auth/admin flows in `lib/auth.ts`, `lib/admin.ts`, and
  `routes/api/admin/*` consistent with existing access checks.
