...
export const MELEE_TRAITS: MeleeTraitDefinition[] = [
  ...
  },
  {
    ...
    name: "Crushing",
    description:
      "Weapon is meant to bludgeon enemies dead. Ignores damage penalties such as armor, or a lizardgirl's scales. Has light armor piercing ( can damage lightly armored vehicles ). Deals +2 damage against enemies that'd otherwise give you a damage penalty.",
  },
  {
    id: "extra-long",
    name: "Extra long",
  ...
  },
  {
    ...
    name: "Duelling",
    description:
      "This weapon is meant for duels and one-on-one's. If a single enemy is in melee range, gain +3d6 to attack and defend yourself against them. If there's more than one, instead gain -1d6 for each enemy, up to -3d6. If you're holding an item in your other hand, gain -3d6 to any attack/defense, disregarding the positive effect of this trait.",
  },
  {
    id: "parrying",
    name: "Parrying",
