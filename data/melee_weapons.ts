...
export const MELEE_WEAPONS: MeleeWeaponTemplate[] = [
  // ── Blades ─────────────────────────────────────────────────────────────
  {
    ...
    damage: 1,
    weight: 0,
    traitIds: ["rapid-shanking", "concealable", "throwable", "one-handed"],
    description: "Short double-edged blade. Can be hidden under clothing and thrown.",
  },
  {
    id: "combat-knife",
    name: "Combat Knife",
    damage: 2,
    weight: 0,
    traitIds: ["rapid-shanking", "one-handed"],
    description: "Standard military fighting knife.",
  },
  {
    id: "throwing-knife",
    name: "Throwing Knife",
    damage: 1,
    weight: 0,
    traitIds: ["throwable", "rapid-shanking", "concealable"],
  ...
  },
  {
    ...
    weight: 0,
    traitIds: ["one-handed"],
    description: "Blade detached from its rifle mount.",
  },
  {
    id: "kukri",
    name: "Kukri",
    ...
    weight: 1,
    traitIds: ["one-handed"],
    description: "Heavy inward-curved blade originating from the Gurkhas.",
  },
  {
    id: "sabre",
    name: "Sabre",
