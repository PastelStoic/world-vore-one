...
*This is where you come in: Whenever you orgasm inside a PF's vagina - pregnancy is not required - that PF can only birth Pilzherrs from there on out.
...
->"You may not forcefully transform innocents into ghouls/vampyrs. Non-innocents are fair game."
->"You must obey your elder Vampyrs."
->"You may not harm a fellow Vampyr."
->"You must instruct this code upon whatever Vampyrs you create."
